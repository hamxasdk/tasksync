...
const MarketingPage = () => {
  return (
    <div className="flex items-center justify-center flex-col">
      <div className={cn("flex item-center justify-center flex-col",headingFont.className)}>
        <div
      ...
      <div className={cn("text-small md:text-xl text-neutral-400 mt-4 max-w-sx md:max-w-2xl text-center mx-auto",textFont.className)}>
        Collaborate, manage projects, and reach new productivity peaks.
        From high rises to the home office, the way your team works
is unique - accomplish it all with TaskSync.
      </div>
